...
def transform(df, *args, **kwargs):
    ...
    payment_dim['payment_name'] = payment_dim['payment_type'].map(payment_name_type)
    ...
    fact_table = df.merge(passenger_count_dim, left_on='trip_id', right_on='passenger_count_id')\
        ...
        'pickup_location_id', 'drop_location_id', 'payment_id','fare_amount', 'extra', 'mta_tax', 'tip_amount', 'tolls_amount',
